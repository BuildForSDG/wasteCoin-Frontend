...
function UserSidebar(props) {
  ...
  const roleTitle = userDetails && userDetails.user_details && userDetails.user_details.role === "agent" ? "Agent" : "";

  return (
    <nav className="sidenav">
      <p className="welcome-text d-none d-lg-block">Welcome ! {roleTitle} {(userDetails && userDetails.user_details && userDetails.user_details.first_name) || ""}</p>
