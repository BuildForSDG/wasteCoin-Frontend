            ...
            <div className="col-md-7 col-sm-12">
                <div className="row">
                    ...
                    <div className="col-md-9 col-sm-8">
                        <div id="team-1" className="team-single active">
                            <div className="team-img">
                                <img src="http://www.webcoderskull.com/img/team4.png" alt=""></img>
                                <div className="team-social">
                                  <ul>
                                    <li><a href="http://www.github.com/AminuIsrael/" target="_blank"><i className="fa fa-github"></i></a></li>
                        ...
                        <div id="team-2" className="team-single">
                              <div className="team-img">
                                  <img src="http://www.webcoderskull.com/img/team2.png" alt=""></img>
                                  <div className="team-social">
                                      <ul>
                                        <li><a href="http://www.github.com/albert85/" target="_blank"><i className="fa fa-github"></i></a></li>
                                        <li><a href=""><i className="fa fa-twitter"></i></a></li>
                                        <li><a href=""><i className="fa fa-whatsapp"></i></a></li>
                                        <li><a href=""><i className="fa fa-linkedin"></i></a></li>
                                      </ul>
                          ...
                          <div id="team-3" className="team-single">
                              <div className="team-img">
                                  <img src="http://www.webcoderskull.com/img/team3.png" alt=""></img>
                                  <div className="team-social">
                                      <ul>
                                        <li><a href="http://www.github.com/chidoziemanagwu/" target="_blank"><i className="fa fa-github"></i></a></li>
                                        <li><a href=""><i className="fa fa-twitter"></i></a></li>
                                        <li><a href=""><i className="fa fa-whatsapp"></i></a></li>
                                        <li><a href=""><i className="fa fa-linkedin"></i></a></li>
                                      </ul>
                          ...
                          <div id="team-4" className="team-single">
                              <div className="team-img">
                                  <img src="http://www.webcoderskull.com/img/team1.png" alt=""></img>
                                  <div className="team-social">
                                      <ul>
                                        <li><a href="http://www.github.com/byruzyayandy1/" target="_blank"><i className="fa fa-github"></i></a></li>
                                        <li><a href=""><i className="fa fa-twitter"></i></a></li>
                                        <li><a href=""><i className="fa fa-whatsapp"></i></a></li>
                                        <li><a href=""><i className="fa fa-linkedin"></i></a></li>
                                      </ul>
                          ...
                          <div id="team-5" className="team-single">
                            <div className="team-img">
                                <img src="http://www.webcoderskull.com/img/team4.png" alt=""></img>
                                <div className="team-social">
                                    <ul>
                                      <li><a href="http://www.github.com/moxeey/" target="_blank"><i className="fa fa-github"></i></a></li>
                                      <li><a href=""><i className="fa fa-twitter"></i></a></li>
                                      <li><a href=""><i className="fa fa-whatsapp"></i></a></li>
                                      <li><a href=""><i className="fa fa-linkedin"></i></a></li>
                                    </ul>
                        ...
                        <div id="team-6" className="team-single">
                          <div className="team-img">
                              <img src="http://www.webcoderskull.com/img/team2.png" alt=""></img>
                              <div className="team-social">
                                  <ul>
                                    <li><a href="http://www.github.com/todak2000/" target="_blank"><i className="fa fa-github"></i></a></li>
                                    <li><a href=""><i className="fa fa-twitter"></i></a></li>
                                    <li><a href=""><i className="fa fa-whatsapp"></i></a></li>
                                    <li><a href="http://www.linkedin.com/in/daniel-olagunju-79b7b9b5/" target="_blank"><i className="fa fa-linkedin"></i></a></li>
                                  </ul>
                              </div>
                          </div>
                          <div className="team-info text-center">
                      ...
                      <div id="team-7" className="team-single">
                          <div className="team-img">
                              <img src="http://www.webcoderskull.com/img/team3.png" alt=""></img>
                              <div className="team-social">
                                  <ul>
                                    <li><a href="http://www.github.com/stephen-kamau/" target="_blank"><i className="fa fa-github"></i></a></li>
                                    <li><a href=""><i className="fa fa-twitter"></i></a></li>
                                    <li><a href=""><i className="fa fa-whatsapp"></i></a></li>
