...
### Please Note: 
1.  When you register, your phone number would be verified as verification code would be sent to that dphone number. Thus  input the right phone number.

2.  This only works for Nigerian Phone numbers for now

3.  To test the REDEEM COIN functionality, you would need to be credited by our Agents. You can reach out to us via wastecoinng@gmail.com to credit you with some coins. So you can attempt to redeem some or all your coins.
